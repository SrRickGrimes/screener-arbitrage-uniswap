...
export interface MockUniswapRouterInterface extends Interface {
  getFunction(
    nameOrSignature: "amountOut" | "getAmountsOut" | "setAmountOut"
  ): FunctionFragment;
...
export interface MockUniswapRouter extends BaseContract {
  ...
  amountOut: TypedContractMethod<[], [bigint], "view">;
  ...
  ): TypedContractMethod<[_amountOut: BigNumberish], [void], "nonpayable">;
